  ...
  return (
    <Box sx={{ p: 3 }}>
      <Typography variant="h3" gutterBottom>
        {t('projects.project4Title')} {/* Translated project title */}
      </Typography>
      <Typography variant="body1" paragraph>
        {t('projects.project4Description')} {/* Translated project description */}
      </Typography>
      
      {/* Add more content related to Project 4 here */}
