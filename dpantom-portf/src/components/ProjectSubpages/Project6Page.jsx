  ...
  return (
    <Box sx={{ p: 3 }}>
      <Typography variant="h3" gutterBottom>
        {t('projects.project6Title')} {/* Translated project title */}
      </Typography>
      <Typography variant="body1" paragraph>
        {t('projects.project6Description')} {/* Translated project description */}
      </Typography>
      
      {/* Add more content related to Project 6 here */}
